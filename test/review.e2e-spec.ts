...
import { CreateReviewDto } from '../src/modules/review/dtos/review.dto'
...
describe('ReviewController (e2e)', () => {
    ...
    /* it('/review/byProduct/delete/:productId (DELETE) - success', async () => {
        const response = await request(app.getHttpServer())
            .delete(`/review/byProduct/delete/${productId}`)
            .expect(200)
        const { body } = response
